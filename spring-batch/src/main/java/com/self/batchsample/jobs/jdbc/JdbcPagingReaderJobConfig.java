...
//         * Spring Batch에서 페이징 쿼리를 쉽게 생성하기 위한 팩토리 빈임
//         * 이 클래스를 사용하면 데이터베이스 종류에 따라 최적화된 페이징 쿼리를 자동으로 생성 할 수 있음.
//         */
//        SqlPagingQueryProviderFactoryBean queryProvider = new SqlPagingQueryProviderFactoryBean();
//        queryProvider.setDataSource(dataSource); // DB에 맞는 PagingQueryProvider를 선택하기 위해서임
//        queryProvider.setSelectClause("id, name, age, gender");
//        queryProvider.setFromClause("from customer");
//        queryProvider.setWhereClause("where age >= :age");
//
//        /**
//         * Order는 스프링 배치에서 제공하는 desc, asc ENUM 클래스임
//         */
//        Map<String, Order> sortKey = new HashMap<>(1);
//        sortKey.put("id", Order.DESCENDING); // 내림차순 정렬 키값 기준으로
//
...
//
//    @Bean
//    public Job customerJdbcPagingJob(Step customerJdbcPagingStep, JobRepository jobRepository) throws Exception {
